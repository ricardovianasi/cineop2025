...
class Formation
{
  ...
  public static function callback($block, $content = '', $is_preview = false, $post_id = 0) {
    ...
    if (!$is_preview) {
      echo '<div class="expanded"><div class="container">';
    }
    ?>
        ...
        ?>
          <div class="formation-item">
            ...
            <div class="desc">
              <?php if ($block_tag): ?>
                <div class="tags">
                  <div class="tag black"><?php echo $block_tag ?></div>
                </div>
              <?php endif; ?>
              <div class="title">
              ...
              <div class="info">
                <?php if( $block_date ): ?><span class="date"><i class="icon-mdi-calendar"></i><?php echo $block_date ?></span><?php endif; ?>
                <?php if( $activity_hour ): ?><span class="hour"><i class="icon-clock"></i><?php echo $activity_hour; ?></span><?php endif; ?>
                <?php if( $block_place ): ?><span class="place"><i class="icon-pin-fill"></i><?php echo $block_place; ?></span><?php endif; ?>
                <?php if($block_workload): ?>
                  <span><i class="icon-clock"></i>carga horária: <?php echo $block_workload; ?></span>
                <?php endif; ?>
                <?php if($block_vacancies): ?>
                  <span><i class="icon-user"></i>vagas: <?php echo $block_vacancies; ?></span>
                <?php endif; ?>
                <?php if($block_age_range): ?>
                  <span><i class="icon-user"></i>faixa etária: <?php echo $block_age_range; ?></span>
                <?php endif; ?>
              </div>
              <p class="excerpt">
              ...
              <div class="cta">
                ...
                <?php if (!$block_readmore): ?>
                  <a class="button button-primary" href="<?php echo get_the_permalink($block) ?>">
                    <?php echo __('Saiba mais')?></a>
                <?php endif; ?>
              </div>
            </div>
          </div>
