    ...
    <div class="container container-1216 flex-col">
              ...
              <div class="workshop-item swiper-slide">
                ...
                <div class="workshop-desc">
                  <div class="workshop-desc-wrapper">
                    <div>
                      <h3 class="title uppercase"><?php echo get_the_title($item) ?></h3>
                    ...
                    <?php if ($item_date): ?>
                      <span class="date uppercase"><?php echo $item_date ?></span>
                    <?php endif; ?>
                    <a class="button button-full-white" href="<?php echo get_the_permalink($item) ?>">Saiba Mais</a>
                  </div>
                </div>
              </div>
            <?php endforeach; ?>
              ...
              <?php foreach ($orderly_trainning_items as $item):
                ...
                <div class="swiper-slide">
                  <?php if(!empty($item_image['ID'])): ?>
                    <?php echo wp_get_attachment_image($item_image['ID'], 'masterclass') ?>
                  <?php endif; ?>
                </div>
              <?php endforeach; ?>
            </div>
      ...
      >
        ...
        <?php if($home_training_link_url): ?>
          <a class="button button-primary" href="<?php echo $home_training_link_url ?>">
            <?php echo $home_training_link_label ?></a>
        <?php endif; ?>
      </div>
    </div>
  </div>
