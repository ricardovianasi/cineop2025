          ...
          <div class="content">
            <div class="section">
              ...
              <?php if (!empty($direcao)): ?>
                <p><strong>Direção:</strong> <?php echo $direcao ?></p>
              <?php endif; ?>
              ...
              <div class="section prog">
                ...
                <div class="info">
                  ...
                  <?php if ($up_general_prog): ?>
                    <a href="<?php echo $up_general_prog ?>" class="button button-primary">Ver Programação Completa</a>
                  <?php endif; ?>
                </div>
              </div>
            <?php endif; ?>
            ...
            <div class="section credits">
              ...
              <div>
                <h3>Créditos</h3>
                <div>
                  <?php if (!empty($producao)): ?><p><strong>Produção:</strong> <?php echo $producao ?></p><?php endif; ?>
                  <?php if (!empty($roteiro)): ?><p><strong>Roteiro:</strong> <?php echo $roteiro ?></p><?php endif; ?>
                  <?php if (!empty($montagem)): ?><p><strong>Montagem:</strong> <?php echo $montagem ?></p><?php endif; ?>
                  <?php if (!empty($fotografia)): ?><p><strong>Fotografia:</strong> <?php echo $fotografia ?></p><?php endif; ?>
                  <?php if (!empty($direcaoArte)): ?><p><strong>Direção de Arte:</strong> <?php echo $direcaoArte ?></p><?php endif; ?>
                  <?php if (!empty($som)): ?><p><strong>Som:</strong> <?php echo $som ?></p><?php endif; ?>
                  <?php if (!empty($empresaProdutora)): ?><p><strong>Empresa produtora:</strong> <?php echo $empresaProdutora ?></p><?php endif; ?>
                  <?php if (!empty($empresasCoProdutoras)): ?><p><strong>Empresa(s) coprodutora(s):</strong> <?php echo $empresasCoProdutoras ?></p><?php endif; ?>
                  <?php if (!empty($distribuidora)): ?><p><strong>Distribuidora:</strong> <?php echo $distribuidora ?></p><?php endif; ?>
                  <?php if (!empty($informacoes_adicionais)) { echo $informacoes_adicionais; } ?>
                  <?php if (!empty($elenco)): ?><p><strong>Elenco:</strong> <?php echo $elenco ?></p><?php endif; ?>
                </div>
              </div>
            </div>
          </div>
